...
console.log('=== POLYMARKET LIQUIDATION MONITOR ===');console.log('5M: LONG >= 700 USDT/USDC; SOL, DOGE and XRP excluded');console.log('15M: SHORT >= 100 USDT/USDC; SOL excluded');console.log('5M and 15M alerts are independent; one link per alert');
