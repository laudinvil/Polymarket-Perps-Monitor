...
console.log('=== POLYMARKET LIQUIDATION MONITOR ===');console.log('5M: LONG >= 700 USDT/USDC');console.log('15M: SHORT with no minimum');console.log('5M and 15M alerts are independent; one link per alert');
