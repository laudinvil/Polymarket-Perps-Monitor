...
async function main() {
  await loadState();
  start15m();
  console.log(`5M liquidation direction-leader monitor started; symbols=${symbols.join(',')}; LONG=1; SHORT>=1; opposite=0; boundary-only alerts; exact closed-bucket evaluation; 15M all symbols enabled`);
