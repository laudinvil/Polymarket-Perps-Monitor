...
const SIGNAL_COOLDOWN_MS = Number(process.env.SIGNAL_COOLDOWN_MS ?? 180000);
const PRICE_MOVE_5M = Number(process.env.PRICE_MOVE_5M ?? 0.001);
const OI_MOVE_5M = Number(process.env.OI_MOVE_5M ?? 0.01);
