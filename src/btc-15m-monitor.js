...
const MAX_LIQUIDATIONS_15M = 300;
...
async function check15mOnce() {
  ...
  if (best < 1 || best > MAX_LIQUIDATIONS_15M || longCount === shortCount) return;
...
async function main15m() {
  console.log(`BTC 15M liquidation monitor started; max=${MAX_LIQUIDATIONS_15M}; no minimum`);
  while (true) {
