...
function persistState() {
  fs.writeFileSync(STATE_FILE, JSON.stringify({ updatedAt: new Date().toISOString(), strategy: state.strategy, symbols: SYMBOLS, processedMarkets: state.processedMarkets, pendingPeriod: state.pendingPeriod, alertedPeriods: state.alertedPeriods, initialized: state.initialized }, null, 2) + '\n');
}
