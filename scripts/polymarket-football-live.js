...
async function discoverPolymarket(){
  ...
  const sources=[
    {name:"soccer_schedule",baseUrl:GAMMA_URL+"/events?tag_slug=soccer&active=true&closed=false&limit=100&order=startDate&ascending=true"},
  ...
  const pagePlan={soccer_schedule:8,sports_schedule:4,soccer_newest:2};
