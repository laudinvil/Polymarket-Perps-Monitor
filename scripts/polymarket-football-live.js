...
function findMatchResultMarket(match) {
  ...
  for (const market of match.markets || []) {
    ...
    for(let i=0;i<outcomes.length;i++){
      ...
      if(o==="draw"||o==="tie"||o==="x") di=i;
      else if(o===home||o.includes(home)||home.includes(o)) hi=i;
      else if(o===away||o.includes(away)||away.includes(o)) ai=i;
    }
    if(hi>=0&&ai>=0&&di>=0) return {market,homeProb:prices[hi],drawProb:prices[di],awayProb:prices[ai]};
  }
  return null;
}
