...
main().catch(error => {
 ...
 + stats.UP.topValue.toFixed(2) + ')' + (stats.UP.topShares > stats.DOWN.topShares ? ' 🔥' : ''),
...
main().catch(error => {
 ...
 + stats.DOWN.topValue.toFixed(2) + ')' + (stats.DOWN.topShares > stats.UP.topShares ? ' 🔥' : ''),
    'TOP HOLDER IMBALANCE: ' + topHolderImbalance.toFixed(2) + '%',
    '',
    '➡️ NEXT · Polymarket 5M',
    '<https://polymarket.com/event/' + nextSlug + '>'
