...
const DISTANCE_THRESHOLD_BPS = 0.6;
const MOMENTUM_THRESHOLD_BPS = 0.25;
const FLOW_THRESHOLD = 0.05;
const DEPTH_THRESHOLD = 0.06;
const MICRO_THRESHOLD_BPS = 0.20;
...
async function sendStrategyAlert(coin, market, decision) {
  ...
  const message = [
    ...
    'DISTANCE: ' + fmt(decision.distanceBps, 4) + ' bps',
    '',
